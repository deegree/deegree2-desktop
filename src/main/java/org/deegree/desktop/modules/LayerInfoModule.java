...
import org.deegree.desktop.commands.ObjectInfoCommand;
import org.deegree.desktop.commands.RefreshFeatureInfoCommand;
import org.deegree.desktop.commands.SelectFeatureCommand;
...
import org.deegree.desktop.views.FeatureTable;
...
/**
 * Module for handling access to available information of a layer
 * 
        ...
        if ( command.getName().equals( ObjectInfoCommand.commandName ) ) {
            ...
            if ( !this.componentStateAdapter.isClosed() ) {
                ...
                if ( fc != null ) {
                    ...
                    && !this.componentStateAdapter.isClosed() ) {
