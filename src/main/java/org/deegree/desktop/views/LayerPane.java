...
import org.deegree.desktop.modules.FeatureLayer;
import org.deegree.desktop.modules.IModule;
import org.deegree.desktop.modules.LazyFeatureLayer;
import org.deegree.desktop.modules.LazyRasterLayer;
...
public class LayerPane implements ChangeListener {
    ...
    private org.deegree.desktop.mapmodel.Layer layer;
     ...
     * @throws ViewException
     */
    public void setModel( MapModel mapModel, org.deegree.desktop.mapmodel.Layer layer )
                            throws ViewException {
        this.layer = layer;
     ...
     */
    public org.deegree.desktop.mapmodel.Layer getLayer() {
        return layer;
    }
