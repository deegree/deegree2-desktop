...
/**
 * <code>LabelStylePerpendicularOffsetPanel</code>
 * 
 ...
 * 
 */
public class PerpendicularOffsetPanel extends AbstractStyleAttributePanel {

    private static final long serialVersionUID = -784536068205183987L;

    private JSpinner fixedOffsetSpinner;

    public PerpendicularOffsetPanel( VisualPropertyPanel assignedVisualPropPanel, ComponentType componentType,
    ...
    protected JComponent getStyleAttributeComponent() {
        // init
        this.fixedOffsetSpinner = new JSpinner();

        return fixedOffsetSpinner;
    }
    ...
    public Object getValue() {
        return fixedOffsetSpinner.getValue();
    }
