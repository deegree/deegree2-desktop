...
import static org.deegree.desktop.views.swing.util.GenericFileChooser.showSaveDialog;
        ...
        SelectScalePanel() {
            ...
            scale.getEditor().getEditorComponent().addFocusListener( new FocusListener() {
                public void focusGained( FocusEvent e ) {
                    ( (Wizard) GuiUtils.getOwnerFrame( getParent() ) ).disableDefaultButton();
                }

                public void focusLost( FocusEvent e ) {
                    ( (Wizard) GuiUtils.getOwnerFrame( getParent() ) ).enableDefaultButton();
                }
            } );
