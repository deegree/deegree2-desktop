...
/*----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
package org.deegree.desktop.views.swing.style.component.classification.edit;
...
import org.deegree.desktop.views.swing.style.component.placement.DisplacementEditor;
import org.deegree.desktop.views.swing.style.renderer.PropertyNameRenderer;
...
/**
 * {@link JPanel} to define the displacement in a classification.
 * 
 ...
 */
public class DisplacementClassificationPanel extends JPanel {

    private static final long serialVersionUID = -6313676608822867275L;
    ...
    public DisplacementClassificationPanel( Object displacement, String title, List<QualifiedName> properties ) {
        this.title = title;
        ...
        displacementEditor = new DisplacementEditor();
        if ( displacement instanceof Pair<?, ?> ) {
            ...
            displacementEditor.setValue( ( (Point2d) displacement ).x, ( (Point2d) displacement ).y );
        } else {
            fixed.setSelected( true );
        }
        ...
        builder.addSeparator( get( "$MD11709" ), cc.xyw( 1, 1, 3 ) );
        builder.add( fixed, cc.xy( 2, 2 ) );
        builder.add( displacementEditor, cc.xy( 3, 2 ) );

        builder.addSeparator( get( "$MD11710" ), cc.xyw( 1, 4, 3 ) );
        builder.add( property, cc.xywh( 2, 5, 1, 4 ) );
        builder.addLabel( get( "$MD10825" ), cc.xy( 3, 5 ) );
        builder.add( propertyCBx, cc.xy( 3, 6 ) );
        builder.addLabel( get( "$MD10826" ), cc.xy( 3, 7 ) );
    ...
    public Object getValue() {
        if ( property.isSelected() ) {
            ...
            return displacementEditor.getValue();
        }
    }
