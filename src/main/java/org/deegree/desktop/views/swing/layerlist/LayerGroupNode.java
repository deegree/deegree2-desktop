...
import org.deegree.desktop.views.swing.layerlist.DnDJTree.TreeLabel;
 ...
 */
class LayerGroupNode extends CheckNode {
     ...
     * @param nodeType
     */
    public LayerGroupNode( LayerGroup userObject, NODE_TYPE nodeType ) {
     ...
     * @param isSelected
     */
    public LayerGroupNode( LayerGroup userObject, NODE_TYPE nodeType, boolean allowsChildren, boolean isSelected ) {
    ...
    public String toString() {
        return ( (LayerGroup) userObject ).getTitle();
    }
    ...
    public void setSelected( boolean selected ) {
        ...
        ( (LayerGroup) userObject ).setVisible( selected );
    }

    @Override
    public boolean isSelected() {
        return ( (LayerGroup) userObject ).isVisible();
    }
