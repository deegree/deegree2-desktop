 ...
 */
public class FontFamilyClassificationPanel extends JPanel {
    ...
    public FontFamilyClassificationPanel( Object fontFamily, String title, List<QualifiedName> properties ) {
        this.title = title;
        ...
        fixedCB = ffh.createFontFamilyChooser();
        ...
        builder.addSeparator( get( "$MD11677" ), cc.xyw( 1, 1, 3 ) );
        builder.add( fixed, cc.xy( 2, 2 ) );
        builder.add( fixedCB, cc.xy( 3, 2 ) );

        builder.addSeparator( get( "$MD11678" ), cc.xyw( 1, 4, 3 ) );
