...
package org.deegree.desktop.views.swing.util.panels;
...
public class PanelDialog extends JDialog implements ActionListener {
     ...
     * @param cancel
     */
    public PanelDialog( Container parent, Component panel, boolean cancel ) {
        this.panel = panel;
        init( cancel );
        pack();
        setResizable( false );
     ...
     */
    public static PanelDialog create( Container parent, Component panel, boolean cancel ) {
        if ( parent != null && parent instanceof JFrame ) {
            return new PanelDialog( (JFrame) parent, panel, cancel );
        }
        if ( parent != null && parent instanceof JDialog ) {
            return new PanelDialog( (JDialog) parent, panel, cancel );
        }
