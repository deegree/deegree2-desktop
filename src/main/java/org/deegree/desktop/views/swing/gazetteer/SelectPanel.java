...
import org.deegree.desktop.commands.gazeetteer.GazetteerFindChildrenCommand;
...
public class SelectPanel extends javax.swing.JPanel {
    ...
    void load() {
        ...
        ( (DeegreeDesktop) appCont ).getMainWndow().setCursor( CursorRegistry.WAIT_CURSOR );
        try {
            ...
            ( (DeegreeDesktop) appCont ).getMainWndow().setCursor( CursorRegistry.DEFAULT_CURSOR );
        }
