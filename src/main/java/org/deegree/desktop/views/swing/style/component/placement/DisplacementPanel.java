...
import org.deegree.desktop.views.swing.style.UomChangedEvent;
import org.deegree.desktop.views.swing.style.VisualPropertyPanel;
import org.deegree.desktop.views.swing.style.component.UnitsPanel;
 ...
 * 
 */
public class DisplacementPanel extends AbstractPlacementPanel implements ChangeListener {
    ...
    protected JComponent getStyleAttributeComponent() {
        ...
        unitsPanel = new UnitsPanel( new org.deegree.desktop.ChangeListener() {
        ...
        FormLayout fl = new FormLayout(
                                        "$rgap, 15dlu, fill:max(100dlu;pref):grow(0.5), 1dlu, fill:max(100dlu;pref):grow(0.5)",
