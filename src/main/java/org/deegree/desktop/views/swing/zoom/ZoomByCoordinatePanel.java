...
import org.deegree.desktop.mapmodel.CRSEntry;
...
import org.deegree.desktop.modules.ZoomByCoordinatesModule;
...
public class ZoomByCoordinatePanel extends DefaultPanel implements ChangeListener {
    ...
    public void valueChanged( ValueChangedEvent event ) {
        if ( event instanceof MapModelChangedEvent
             && ( (MapModelChangedEvent) event ).getChangeType() == CHANGE_TYPE.extentChanged ) {
            setXY();
        }
    }
