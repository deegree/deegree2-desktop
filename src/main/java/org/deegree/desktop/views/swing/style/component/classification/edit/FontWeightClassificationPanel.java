 ...
 */
public class FontWeightClassificationPanel extends JPanel {
    ...
    public FontWeightClassificationPanel( Object fontFamily, String title, List<QualifiedName> properties ) {
        this.title = title;
        ...
        fixedCB = ffh.createFontWeightChooser();
        ...
        builder.addSeparator( get( "$MD11688" ), cc.xyw( 1, 1, 3 ) );
        builder.add( fixed, cc.xy( 2, 2 ) );
        builder.add( fixedCB, cc.xy( 3, 2 ) );

        builder.addSeparator( get( "$MD11689" ), cc.xyw( 1, 4, 3 ) );
