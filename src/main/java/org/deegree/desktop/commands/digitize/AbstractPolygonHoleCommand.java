 ...
 */
abstract class AbstractPolygonHoleCommand extends AbstractCommand {
    /**
     * 
     * @param ring
     * @return true if an array of passed {@link Position} forms a clockwise orientated ring
     */
    protected static boolean isClockwise( Position[] ring ) {
     ...
     * @param inner
     */
    protected static void invertPositionOrder( Position[] inner ) {
