...
/**
 * {@link Command} implementation for appliying a change of a style assigned to a layer
 * 
 ...
 * 
 */
public class ChangeLayerStyleCommand extends AbstractCommand {

    private static final QualifiedName commandName = new QualifiedName( "ChangeLayerStyleCommand" );

    private Layer layer;

    private NamedStyle style;

    public ChangeLayerStyleCommand( Layer layer, NamedStyle style ) {
        this.layer = layer;
        this.style = style;
    }
