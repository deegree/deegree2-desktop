...
import org.deegree.desktop.dataadapter.wcs.WCSCapabilitiesEvaluator;
...
import org.deegree.desktop.settings.WCSGridCoverageAdapterSettings;
...
public class AddWCSLayerCommand extends AbstractCommand {
    ...
    private org.deegree.desktop.mapmodel.Layer newLayer;
    ...
    public void execute()
        ...
        // create a new layer
        newLayer = new org.deegree.desktop.mapmodel.Layer( mapModel, id, tmp, this.layerAbstract, datasources,
                                                        this.metadataURLs );
