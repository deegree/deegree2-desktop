...
/**
 * {@link Command} implementation for selecting a geometry by its (X)path
 * 
 ...
 */
public class SelectGeometryCommand extends AbstractCommand {
     ...
     * 
     * @param layer
     *            layer containing the feature/geometry to be selected
     * @param fid
     *            id of feature from which a geometry should be selected
     * @param propertyPath
     *            path of the geometry to be selected
     */
    public SelectGeometryCommand( Layer layer, Identifier fid, PropertyPath propertyPath ) {
        this.layer = layer;
        this.fid = fid;
    ...
    public void execute()
                            throws Exception {
        layer.selectGeometry( fid, propertyPath );
    ...
    public QualifiedName getName() {
        return new QualifiedName( "SelectGeometryCommand" );
    }
