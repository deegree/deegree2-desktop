...
import org.deegree.desktop.style.model.Preset;
...
import org.deegree.desktop.config.ColorListType;
...
public class GraphicOptions extends ElementSettings {
    ...
    private Map<String, org.deegree.desktop.style.model.DashArray> dashArrays;
    ...
    private void createDashArraysMapMap( List<DashArray> das ) {
        if ( dashArrays == null ) {
            dashArrays = new HashMap<String, org.deegree.desktop.style.model.DashArray>( das.size() );
            for ( DashArray dashArray : das ) {
                float[] array = StringTools.toArrayFloat( dashArray.getArray(), ", " );
                org.deegree.desktop.style.model.DashArray da = new org.deegree.desktop.style.model.DashArray(
                                                                                                        dashArray.getName(),
                                                                                                        array );
    ...
    private void createColorSchemes( List<ColorSchemesType> cst ) {
        if ( colorSchemes == null ) {
            ...
            for ( ColorSchemesType colorSchemesType : cst ) {
                List<org.deegree.desktop.config.ColorListType.ColorListEntry> list = colorSchemesType.getColorlist().getColorListEntry();
                List<ColorListEntry> entries = new ArrayList<ColorListEntry>( list.size() );
                for ( org.deegree.desktop.config.ColorListType.ColorListEntry colorListEntry : list ) {
     ...
     * @return mapping of fill pattern names and file containing a fill pattern
     */
    public Map<String, org.deegree.desktop.style.model.DashArray> getDashArrays() {
     ...
     * @param dashArray
     */
    public void addDashArray( String name, org.deegree.desktop.style.model.DashArray dashArray ) {
        if ( changeable ) {
    ...
    public void addColorScheme( String name, List<ColorListEntry> entries ) {
        if ( changeable ) {
            ...
            for ( ColorListEntry colorListEntry : entries ) {
                org.deegree.desktop.config.ColorListType.ColorListEntry cle = new org.deegree.desktop.config.ColorListType.ColorListEntry();
