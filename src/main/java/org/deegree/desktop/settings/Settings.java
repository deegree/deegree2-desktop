...
import org.deegree.desktop.dataadapter.wms.WMS130CapabilitiesEvaluator;
...
import org.deegree.desktop.config.AuthenticationType;
import org.deegree.desktop.config.ClipboardType;
import org.deegree.desktop.config.ColorSchemesType;
import org.deegree.desktop.config.DashArrayDefinitionsType;
import org.deegree.desktop.config.DataAdapterType;
import org.deegree.desktop.config.DictionariesType;
import org.deegree.desktop.config.DigitizingOptionsType;
import org.deegree.desktop.config.ExternalReferencesType;
import org.deegree.desktop.config.FileAccessType;
import org.deegree.desktop.config.FileFilterType;
import org.deegree.desktop.config.FormatsType;
import org.deegree.desktop.config.GeometryMetricsType;
import org.deegree.desktop.config.GeometryTopologyType;
import org.deegree.desktop.config.GeometryTypeType;
import org.deegree.desktop.config.GraphicDefinitionsType;
import org.deegree.desktop.config.GraphicLineSizeType;
import org.deegree.desktop.config.GraphicsType;
import org.deegree.desktop.config.HelpContextType;
import org.deegree.desktop.config.MapHandlingType;
import org.deegree.desktop.config.OnlineResourceType;
import org.deegree.desktop.config.PresetType;
import org.deegree.desktop.config.ProjectTemplatesType;
import org.deegree.desktop.config.SecurityType;
import org.deegree.desktop.config.ServiceAdapterType;
import org.deegree.desktop.config.SettingsType;
import org.deegree.desktop.config.SnapLayerType;
import org.deegree.desktop.config.SnappingType;
import org.deegree.desktop.config.ValidationType;
import org.deegree.desktop.config.VerticesType;
import org.deegree.desktop.config.WFSDefaultStyleType;
import org.deegree.desktop.config.WFSFeatureAdapterType;
import org.deegree.desktop.config.WMSGridCoverageAdapterType;
import org.deegree.desktop.config.DashArrayDefinitionsType.DashArray;
import org.deegree.desktop.config.DataAdapterType.KnownRasterFormats;
import org.deegree.desktop.config.DatabaseDriversType.Database;
import org.deegree.desktop.config.ExternalReferencesType.Reference;
import org.deegree.desktop.config.FileAccessType.Access;
import org.deegree.desktop.config.FileFilterType.Format;
import org.deegree.desktop.config.GraphicDefinitionsType.Graphic;
import org.deegree.desktop.config.HelpContextType.Page;
import org.deegree.desktop.config.MapHandlingType.PanLevel;
import org.deegree.desktop.config.MapHandlingType.ZoomLevel;
import org.deegree.desktop.config.ProjectTemplatesType.Template;
import org.deegree.desktop.config.ServiceAdapterType.CapabilitiesEvaluator;
import org.deegree.desktop.config.VerticesType.SearchRadius;
...
public class Settings {
    ...
    public FormatsOptions getFormatsOptions() {
        ...
        if ( adminSettings != null && adminSettings.getFormats() != null ) {
            List<org.deegree.desktop.config.FormatsType.Format> list = adminSettings.getFormats().getFormat();
            for ( org.deegree.desktop.config.FormatsType.Format format : list ) {
        ...
        if ( changeable && userSettings != null && userSettings.getFormats() != null ) {
            List<org.deegree.desktop.config.FormatsType.Format> list = userSettings.getFormats().getFormat();
            List<org.deegree.desktop.config.FormatsType.Format> list2 = formatsType.getFormat();
            for ( org.deegree.desktop.config.FormatsType.Format format : list ) {
                boolean tmp = false;
                for ( org.deegree.desktop.config.FormatsType.Format format2 : list2 ) {
        ...
        if ( changeable && projectSettings.getFormats() != null ) {
            List<org.deegree.desktop.config.FormatsType.Format> list = projectSettings.getFormats().getFormat();
            List<org.deegree.desktop.config.FormatsType.Format> list2 = formatsType.getFormat();
            for ( org.deegree.desktop.config.FormatsType.Format format : list ) {
                boolean tmp = false;
                for ( org.deegree.desktop.config.FormatsType.Format format2 : list2 ) {
