...
import static org.deegree.desktop.config.Util.convertIdentifier;
import static org.deegree.desktop.i18n.Messages.getMessage;
...
import org.deegree.desktop.modules.DefaultModuleGroup;
import org.deegree.desktop.modules.IModule;
import org.deegree.desktop.modules.IModuleGroup;
...
import org.deegree.desktop.views.IFooterEntry;
import org.deegree.desktop.views.ComponentPosition.BorderPosition;
import org.deegree.desktop.views.ComponentPosition.SplitterPosition;
...
import org.deegree.desktop.views.swing.FooterEntry;
import org.deegree.desktop.views.swing.MenuBar;
...
import org.deegree.desktop.config.AcceleratorType;
import org.deegree.desktop.config.EntryValueType;
...
import org.deegree.desktop.config.MenuItemType;
 ...
 */
public class DeegreeDesktop extends AbstractDeegreeDesktop {

    private static final ILogger LOG = LoggerFactory.getLogger( DeegreeDesktop.class );
     ...
     * 
     */
    public DeegreeDesktop( ProcessMonitor processMonitor ) {
    ...
    public void actionPerformed( ActionEvent event ) {
        DeegreeDesktopEventHandler.actionPerformed( this, event );
    }
    ...
    public static void main( String[] args ) {
        ...
        try {
            ...
            spw.setVisible( true );
            DeegreeDesktop g = new DeegreeDesktop( spw );
            URL url = null;
            if ( args == null || args.length == 0 ) {
                url = DeegreeDesktop.class.getResource( "/default.prj" );
            } else {
