...
/**
 * 
 * Dialog presented to users for login if a security environment is a vailable
 * 
...
public class LoginDialog extends javax.swing.JDialog {
    ...
    private ApplicationContainer<Container> iGeoDesktop;
     ...
     * @param iGeoDesktop
     */
    public LoginDialog( ApplicationContainer<Container> iGeoDesktop ) {
        this.iGeoDesktop = iGeoDesktop;
        initGUI();
        setVisible( true );
        setModal( true );
        Rectangle rect = iGeoDesktop.getMainWndow().getBounds();
                                                                  ...
                                                                  0 ) );
                    {
                        ...
                        ActionListener al = new ActionListener() {
                            public void actionPerformed( ActionEvent e ) {
                                dispose();
                                Preferences prefs = Preferences.userNodeForPackage( DeegreeDesktop.class );
