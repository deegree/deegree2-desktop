 ...
 */
public class QualityClassification<U extends Comparable<U>> extends AbstractClassification<U> {
    ...
    public List<ValueRange<U>> getValues() {
        return classificationCalculator.calculateQualityClassification( data );
    }
