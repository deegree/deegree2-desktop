...
/**
 * {@link Command} implementation for finding/creating intersections between geometries contained in one or two layers.
 * The result will be added as new layer
 * 
...
public class LayerIntersectionCommand extends AbstractCommand {
     ...
     */
    public LayerIntersectionCommand( Layer mainLayer, Layer compareLayer, String newLayerName ) {
     ...
     */
    public LayerIntersectionCommand( Layer mainLayer, Layer compareLayer,
                                     String newLayerName, INTERSECTION_TYPE intersectiontype ) {
        this.mainLayer = mainLayer;
        this.compareLayer = compareLayer;
        this.newLayerName = newLayerName;
