...
/**
 * <code>QuantileClassification</code> A classification by equal number of values in each class.
 * 
 ...
 * 
 */
public class QuantileClassification<U extends Comparable<U>> extends AbstractClassification<U> {
    ...
    public List<ValueRange<U>> getValues() {
        return classificationCalculator.calculateQuantileClassification( data, getNumberOfClasses() );
    }
}
