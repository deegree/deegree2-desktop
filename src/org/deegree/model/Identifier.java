...
public class Identifier implements Serializable {
    ...
    /**
     * creates a default Identfier by using a random UUID as value and "http://www.deegree.org" as
     * namespace URI
     * 
     */
    public Identifier() {
        ...
        try {
            this.namespace = new URI( "http://www.deegree.org" );
    ...
    public boolean equals( Object other ) {
        ...
        } else if ( this.namespace == null &&  id.getNamespace() == null ) {          
            if ( ( this.value.equals( id.getValue() ) ) ) {
                return true;
            }
        }
        return false;
