...
import org.deegree.igeo.commands.digitize.JoinCurvesCommand;
import org.deegree.igeo.commands.digitize.JoinCurvesCommand.CURVE_CONNECTION_TYPE;
...
import org.deegree.igeo.views.swing.digitize.construction.JoinCurveParameter.CONNECTION_PARAMETER;
...
public class JoinCurveDialog extends JDialog {
        ...
        addWindowListener( new WindowAdapter() {
            ...
            public void windowOpened( WindowEvent e ) {
                ...
                if ( !ts.getClass().equals( CreateArcFeatureState.class ) ) {
                    ...
                    if ( cbConnectionType.getSelectedIndex() > 0 ) {
    ...
    public void joinCurves()
        ...
        if ( panel == null ) {
            ...
            Feature feature1 = featureAdapter.getFeatureCollection( point1 ).getFeature( 0 );
            Feature feature2 = featureAdapter.getFeatureCollection( point2 ).getFeature( 0 );
            if ( feature1 == null ) {
