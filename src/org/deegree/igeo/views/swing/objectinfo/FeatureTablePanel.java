...
public class FeatureTablePanel extends DefaultPanel implements FeatureTable, ClipboardOwner, ListSelectionListener {
    ...
    public void setFeatureCollection( Layer layer, final FeatureCollection featureCollection ) {
        ...
        MouseListener[] ml = header.getMouseListeners();
        if ( ml != null ) {
            for ( MouseListener mouseListener : ml ) {
                if ( mouseListener instanceof ColumnHeaderListener ) {
    ...
    public class ColumnHeaderListener extends MouseAdapter {
        ...
        public void mouseReleased( MouseEvent e ) {
            ...
            if ( table.getModel() instanceof FeatureTableModel ) {
                ...
                ( (FeatureTableModel) table.getModel() ).sortByColumn( vColIndex, e.getButton() == 1 );
