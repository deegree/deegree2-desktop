...
public class DefaultMapInnerFrame extends DefaultInnerFrame implements ChangeListener {
    ...
    private class DMIFComponentListener extends ComponentAdapter {
        ...
        public void componentHidden( ComponentEvent arg0 ) {
            ...
            // remove footer entry
            if ( dmc.getPrivateFooter() == null && owner.getApplicationContainer() != null ) {
                //IFooter footer = owner.getApplicationContainer().getFooter();
                //footer.removeEntry( dmc.getMmcFooterentryName() );
                //footer.repaintFooter();
            }
        }
