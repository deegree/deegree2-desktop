...
public class IGeoFileChooser extends JDialog {
     ...
     * @param parentClass
     */
    public IGeoFileChooser( IGeoDesktop appCont, File directory, String extension, FILECHOOSERTYPE fileChooserType,
                            boolean open ) {
        super( appCont.getMainWndow() );
