...
public abstract class AbstractClassificationPanel extends JPanel implements ActionListener, TableModelListener {
     ...
     * @param dynamic
     */
    public AbstractClassificationPanel( VisualPropertyPanel assignedVisualPropPanel, ComponentType componentType ) {
    ...
    private class ClassesTable extends JTable {
        ...
        public TableCellEditor getCellEditor( int row, int column ) {
            ...
            case LINESTYLE:
                ...
                break;
            case SIZE:
                editor = new SpinnerTableCellEditor( SldValues.getDefaultSize(), 1.0, 100.0, 1.0 );
                break;
            case SYMBOL:
