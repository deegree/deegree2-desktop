...
/**
 * <code>EqualIntervalClassification</code> A classification by equal intervals of the classes.
 * 
 ...
 * 
 */
public class EqualIntervalClassification<U extends Comparable<U>> extends AbstractClassification<U> {
    ...
    public List<ValueRange<U>> getValues() {
        return classificationCalculator.calculateEqualInterval( data, getNumberOfClasses() );
    }
