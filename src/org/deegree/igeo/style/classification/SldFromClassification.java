...
public class SldFromClassification<U extends Comparable<U>> {
    ...
    public final List<Rule> createLabelClassificationRules( List<ClassificationTableRow<U>> classification,
        ...
        for ( int i = 0; i < classification.size(); i++ ) {
            ...
            addParameter( fontParams, "font-size", row.getValue( COLUMNTYPE.FONTSIZE ), isInPixel, 1 );
     ...
     * @param isInPixel
     */
    private void addParameter( Map<String, CssParameter> params, String name, Object value, boolean isInPixel, int add ) {
        if ( value != null ) {
