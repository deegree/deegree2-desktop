...
public class UnitsValue {
    ...
    public static UnitsValue readFromParameterValueType( ParameterValueType pvt, double defaultValue ) {
        ...
        if ( pvt.getComponents() != null && pvt.getComponents().length > 0 ) {
            if ( pvt.getComponents()[0] instanceof ArithmeticExpression ) {
                ArithmeticExpression e = (ArithmeticExpression) pvt.getComponents()[0];
                ...
                if ( ppValue != null ) {
                    if ( ppValue.getAsString().contains( "$SCALE" ) ) {
                        isInMapUnits = true;
                    }
                }
            }
