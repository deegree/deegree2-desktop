    ...
    public class CachedLayer implements ChangeListener {
        ...
        public void valueChanged( ValueChangedEvent event ) {
            if ( event instanceof LayerChangedEvent ) {
                ...
                if ( ( (LayerChangedEvent) event ).getChangeType().equals( LAYER_CHANGE_TYPE.datasourceAdded )
                     || ( (LayerChangedEvent) event ).getChangeType().equals( LAYER_CHANGE_TYPE.datasourceRemoved )
                     || ( (LayerChangedEvent) event ).getChangeType().equals( LAYER_CHANGE_TYPE.datasourceChanged ) ) {
                    refreshPropertyValues();
                }
            }
