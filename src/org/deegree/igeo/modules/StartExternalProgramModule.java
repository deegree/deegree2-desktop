...
import static org.deegree.igeo.views.swing.util.GenericFileChooser.FILECHOOSERTYPE.geoDataFile;
...
/**
 * <code>StartExternalProgramModule</code>
 * 
...
public class StartExternalProgramModule<T> extends DefaultModule<T> {
    ...
    public void startProgram() {
        try {
            ...
            JFrame window = ( (IGeoDesktop) appContainer ).getMainWndow();
            if ( layers.isEmpty() ) {
    ...
    public void importGDALGPXShapes() {
        try {
            ...
            File file = showOpenDialog( geoDataFile, appContainer, window, prefs,
                                        "lastGpxLoadDir" + getVersionNumber(), GPX );
            if ( file != null ) {
                File outDir = new File( getProperty( "java.io.tmpdir" ), file.getName() + "_converted" );
