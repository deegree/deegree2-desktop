...
public class JoinCurvesCommand extends AbstractCommand {
    ...
    private void executeTangent()
                            throws Exception {
        Pair<Point, Point> points = new Pair<Point, Point>( point1, point2 );
        Pair<Position[], Position[]> segments = findSegements( points );
        ...
        if ( d1 > d2 ) {
            ...
            curve1 = stretchCurve( curve1, point1.getPosition(), p1 );
            ...
            curve2 = stretchCurve( curve2, point2.getPosition(), p2 );
    ...
    private Pair<Position[], Position[]> findSegements( Pair<Point, Point> points )
                            throws Exception {
     ...
     * @throws GeometryException
     */
    private Curve stretchCurve( Curve curve, Position position, Position intersection )
                            throws GeometryException {
